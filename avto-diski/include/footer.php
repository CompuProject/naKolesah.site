...
<div class="footer__phone">
	...
	<div class="footer__phone--callback">
		<button class="btn_modal" id="modal1" onclick="if(siteUrl=='avto-diski'){yaCounter51444733.reachGoal('PMN');return true;}else if(siteUrl=='diski-avto'){yaCounter51463640.reachGoal('PMN');return true;}">
			<span class="text">
				Перезвоните мне
...
<div class="modalWindow modal1" comment="Обратный звонок" modalName="headerCallBack">
    ...
    <div class="callBackModal_content">
        ...
        <div class="modalBtnBlock">
            <button onclick="if(siteUrl=='avto-diski'){yaCounter51444733.reachGoal('PZ_O');return true;}else if(siteUrl=='diski-avto'){yaCounter51463640.reachGoal('PZ_O');return true;}">ЗАКАЗАТЬ ЗВОНОК<span class="ripple rippleEffect" style="width:250px; height:250px; left:-180px; top:-77px;"></span></button>
		</div>
	</div>
</div>
<div class="modalWindow modal2" comment="Наличие дисков в магазинах" modalName="availability_at_the_store">
    <div class="modal_header">
        <button class="close nofonts">×</button>
        <h4 class="textable">
            <p><br></p>
    ...
    <div class="callBackModal_content">
        <div class="modalName">Наличие дисков в магазинах</div>
        <div class="modalText">Оставьте свой телефон и мы уведомим вас о наличии дисков для вашего авто:
		</div>
    ...
    <div class="callBackModal_content">
        <form class="online-selection__form" name="online-selection">
            <div class="step" id="step5">
                <p class="modalName">
                    Шаг <span style="color: #c90000">1</span>/4
				</p>
            ...
            <div class="step" id="step6" style="display: none;">
                <p class="modalName">
                    Шаг <span style="color: #c90000">2</span>/4
				</p>
            ...
            <div class="step" id="step7" style="display: none;">
                <p class="modalName">
                    Шаг <span style="color: #c90000">3</span>/4
				</p>
                <p class="modalText">
            ...
            <div class="step" id="step8" style="display: none;">
                <p class="modalName">
                    Шаг <span style="color: #c90000">4</span>/4
				</p>
                ...
                <div style="padding: 0 20px">
                    <div class="modalInputName">Номер телефона *</div>
                    <div class="modalInputBlock"><input class="modalInput" name="phone" type="tel" required id="modal3_phone"></div>
                </div>

                <div class="modalBtnBlock">
                    <button class="big-yellow-button" type="submit" onclick="if(siteUrl=='avto-diski'){yaCounter51444733.reachGoal('PLD');return true;}else if(siteUrl=='diski-avto'){yaCounter51463640.reachGoal('PLD');return true;}">Посмотреть лучшие диски для моего авто<span class="ripple rippleEffect" style="width:250px; height:250px; left:-180px; top:-77px;"></span></button>
				</div>
...
<div class="modalWindow modal4" comment="Приобретение дисков в рассрочку">
	...
	<div class="modalBtnBlock">
	<button onclick="if(siteUrl=='avto-diski'){yaCounter51444733.reachGoal('BK_O');return true;}else if(siteUrl=='diski-avto'){yaCounter51463640.reachGoal('BK_O');return true;}">СВЯЗАТЬСЯ СО СПЕЦИАЛИСТОМ<span class="ripple rippleEffect" style="width:250px; height:250px; left:-180px; top:-77px;"></span></button>
	</div>
    </div>
	</div>
	<div class="leftModalBtn btn_modal" id="modal5" onclick="if(siteUrl=='avto-diski'){yaCounter51444733.reachGoal('BK');return true;}else if(siteUrl=='diski-avto'){yaCounter51463640.reachGoal('BK');return true;}">
    <img src="//u10.filesonload.ru/s/46opna051/cc9ef35356d18c722781599f1b8cae78/97ebe47d8061d19fd63064e56e15bb36.png">
	</div>
	<script src="assets/js/bootstrap.min.js"></script>
	<script src="assets/js/main.script.js?p=1"></script>
