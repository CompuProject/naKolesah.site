    ...
    <div class="callBackModal_content">
        <form class="online-selection__form" name="online-selection">
            <div class="step" id="step5">
                ...
                <button class="big-yellow-button js-next-step" type="button">Далее<span class="ripple rippleEffect"
...
<div class="modalWindow fakeRoistat modal6 inputForm" modalId="fakeRoistat_modal" comment="Обратный звонок">
...
<div class="leftBottomBtn btn_modal" id="modal6">
