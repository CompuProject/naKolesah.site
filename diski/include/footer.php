<footer class="footer">
    <div class="footer__company">
        <img src="assets/img/logo.png" alt="На колёсах">
        © 2018 "На колесах.ru"
    </div>
    </div>
...
<div class="modalWindow modal1" comment="Обратный звонок" modalName="headerCallBack">
    ...
    <div class="callBackModal_content">
        ...
        <div class="modalBtnBlock">
            <button onclick="ym(yaID[siteUrl], 'reachGoal', 'ZAKAZ_ZVONKA_Z'); return true;">ПЕРЕЗВОНИТЕ МНЕ<span class="ripple rippleEffect" style="width:250px; height:250px; left:-180px; top:-77px;"></span></button>
        </div>
    </div>
</div>
<div class="modalWindow modal2" comment="Наличие дисков в магазинах" modalName="availability_at_the_store">
    ...
    <div class="callBackModal_content">
        ...
        <div class="modalBtnBlock">
            <button onclick="ym(yaID[siteUrl], 'reachGoal', 'PROVERIT_Z'); return true;">ПРОВЕРИТЬ НАЛИЧИЕ ДИСКОВ<span class="ripple rippleEffect" style="width:250px; height:250px; left:-180px; top:-77px;"></span></button>
        </div>
        <div class="modalBtnBlockDescription">Проверка займет не более 10 минут*</div>
    </div>
</div>
    ...
    <div class="callBackModal_content">
        <form class="online-selection__form" name="online-selection">
            ...
            <div class="step" id="step8" style="display: none;">
                ...
                <div class="modalBtnBlock">
                    <button class="big-yellow-button" type="submit" onclick="ym(yaID[siteUrl], 'reachGoal', 'DISKI_Z'); return true;">Посмотреть лучшие диски для моего авто<span class="ripple rippleEffect" style="width:250px; height:250px; left:-180px; top:-77px;"></span></button>
                </div>
...
<div class="modalWindow modal4" comment="Приобретение дисков в рассрочку">
    ...
    <div class="callBackModal_content">
        ...
        <div class="modalBtnBlock">
            <button onclick="ym(yaID[siteUrl], 'reachGoal', 'RASSROCHKA_Z'); return true;">
...
<div class="modalWindow fakeRoistat modal7 inputForm" id="fakeRoistat_modal" comment="Обратный звонок">
...
<div class="leftModalBtn btn_modal" id="modal5" onclick="ym(yaID[siteUrl], 'reachGoal', 'VIDJET'); return true;">
