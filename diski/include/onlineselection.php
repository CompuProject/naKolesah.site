<div class="online-selection">
	<div class="wrapper">
		<div class="container text-center">
			<h2 id="online-selection">Онлайн-сервис подбора моделей дисков</h2>
			...
			<form class="online-selection__form modalWindow" name="online-selection" comment="Подобрать диски" modalName="pick_up_car_drives">
				<div class="step" id="step1">
					...
					<button class="big-yellow-button js-next-step" type="button" onclick="ym(yaID[siteUrl], 'reachGoal', 'DALEE_1'); return true;">
                        <span class="text">Далее<span class="ripple rippleEffect" style="width:250px; height:250px; left:-180px; top:-77px;"></span>
                        </span>
                    </button>
				</div>
				...
				<div class="step" id="step4" style="display: none;">
					...
					<button class="big-yellow-button" id="modal6" onclick="ym(yaID[siteUrl], 'reachGoal', 'QVIZ_Z'); return true;">
                        <span class="text">
