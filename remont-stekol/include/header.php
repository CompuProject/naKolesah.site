...
<head>
    ...
    <script type="text/javascript" >
        ...
        var yaID = [];
        yaID['remont-stekol']='51444862';
        yaID['remont-stekla']='51444874';
    ...
    <noscript><div><img src="https://mc.yandex.ru/watch/51444862" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
    <!-- /Yandex.Metrika counter -->
</head>
<body>
<header class="header">
        ...
        <div class="hamburger1">
            <div plp-hamburger-root="">
                ...
                <div class="hamburger_menu_btnBlock">
                    <a href="tel:88005503695" target="_blank">
        ...
        <div class="header__top">
            ...
            <div class="header__top-phone">
                ...
                <div class="header__top-phone-callback">
                    <button class="btn_modal" id="modal1" onclick="if(siteUrl=='remont-stekol'){yaCounter51444862.reachGoal('PERZI'); return true;}else if(siteUrl=='remont-stekla'){yaCounter51444874.reachGoal('PERZI'); return true;}">
						<span class="text">
                                Перезвоните мне
