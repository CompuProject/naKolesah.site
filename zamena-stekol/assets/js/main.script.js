...
$(document).ready(function () {
    ...
    $('._modal_0 ._modal_content').html('<iframe  class="center-block" id="v_zamena_stekol" width="'+videowidth+'" height="'+videoheight+'" src="https://www.youtube.com/embed/hV7gPrq71HM?rel=0&amp;autoplay=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>');
                ...
                $('._modal_form')
                    ...
                    .animate({top: '15%'}, 600,
                        function() {
                            $('._modal_content')
                                .css('display', 'block');
                            document.getElementById('v_zamena_stekol').contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}', '*');
                        });
            });
