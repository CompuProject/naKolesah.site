...
<div class="modalWindow modal1" comment="Обратный звонок" modalName="headerCallBack">
    ...
    <div class="callBackModal_content">
        ...
        <div class="modalBtnBlock">
            <button onclick="if(siteUrl=='zamena-stekol'){yaCounter51444793.reachGoal('OPA_Z');return true;}else if(siteUrl=='zamena-stekla'){yaCounter51444802.reachGoal('OPA_Z');return true;}">ЗАКАЗАТЬ ЗВОНОК<span class="ripple rippleEffect" style="width:250px; height:250px; left:-180px; top:-77px;"></span></button>
        </div>
    </div>
</div>
...
<div class="modalWindow modal4" comment="Приобретение дисков в рассрочку">
    ...
    <div class="callBackModal_content">
        ...
        <div class="modalText">Оставьте свой телефон и мы свяжемся с вами, чтобы обсудить дату и детали вашего визита:</div>
        <div class="modalInputName">НОМЕР ТЕЛЕФОНА *</div>
        <div class="modalInputBlock"><input name="phone" class="modalInput" id="modal4_phone"></div>
        <div class="modalBtnBlock">
            <button onclick="if(siteUrl=='zamena-stekol'){yaCounter51444793.reachGoal('BUSTRZ_Z');return true;}else if(siteUrl=='zamena-stekla'){yaCounter51444802.reachGoal('BUSTRZ_Z');return true;}">СВЯЗАТЬСЯ<span class="ripple rippleEffect" style="width:250px; height:250px; left:-180px; top:-77px;"></span></button>
        </div>
    </div>
</div>
<div class="modalWindow modal5" comment="Виджет слева">
    ...
    <div class="callBackModal_content">
        ...
        <div class="modalBtnBlock">
            <button onclick="if(siteUrl=='zamena-stekol'){yaCounter51444793.reachGoal('VIDJ');return true;}else if(siteUrl=='zamena-stekla'){yaCounter51444802.reachGoal('VIDJ');return true;}">СВЯЗАТЬСЯ СО СПЕЦИАЛИСТОМ<span class="ripple rippleEffect" style="width:250px; height:250px; left:-180px; top:-77px;"></span></button>
        </div>
    </div>
</div>
...
<div class="leftModalBtn btn_modal" id="modal5" onclick="if(siteUrl=='zamena-stekol'){yaCounter51444793.reachGoal('VIDJ_Z');return true;}else if(siteUrl=='zamena-stekla'){yaCounter51444802.reachGoal('VIDJ_Z');return true;}">
...
<script src="/zamena-stekol/assets/js/main.script.js?p=1"></script>
<script src="/zamena-stekol/assets/js/jquery-asRange.min.js"></script>
<script type="text/javascript" src="/zamena-stekol/assets/js/plp.js"></script>
